...
/// Interface definition for mediaDB observers.
class IMediaDBObserver
{
public:
    virtual ~IMediaDBObserver() {};
     ...
     */
    virtual void mediaDBStateChanged(std::shared_ptr<Device> device) = 0;
     ...
     * \param[in] device The device that changed availability.
     */
    virtual void mediaDBModified(std::shared_ptr<Device> device) = 0;
